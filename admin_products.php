      ...
      <div class="flex">
         ...
         <select name="category" class="box" required>
            <option value="" selected disabled>select category</option>
               <option value="vegitables">Leafy Aromas</option>
               <option value="fruits">Coconut Products</option>
               <option value="meat">Vegitables</option>
               <option value="fish">Grains & Spices</option>
         </select>
         </div>
         <div class="inputBox">
